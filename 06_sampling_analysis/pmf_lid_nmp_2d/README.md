This directory contains files for plotting 2D pmf in the LID/NMP angle space for the sampling simulations with the final mixing parameters (pmfs were already calculated in the "04_md_runs" section):
