...
##############################################################################################################
set NAME_FILE_IN_SIM_DATA xxxxx
set NAME_FILE_IN_TARGETS yyyyy
...
set file_no_path_0 [proc_file_name_no_path [lindex $list_files 0]]
set file_no_path_1 [proc_file_name_no_path [lindex $list_files 1]]
set file_no_path_2 [proc_file_name_no_path [lindex $list_files [expr [llength $list_files]-1]]]
set file_out_name_common_0_1 [proc_str_unite_common $file_no_path_0 $file_no_path_1 xxx]
set file_out_name_common_0_2 [proc_str_unite_common $file_no_path_0 $file_no_path_2 xxx]
set file_out_name_common [proc_str_unite_common $file_out_name_common_0_1 $file_out_name_common_0_2 xxx]
set file_out_name_common [proc_file_name_insert_str $file_out_name_common ene_target]
...
foreach file_name $list_files {
	...
	foreach list_param_target $list_list_targets {
		...
		set file_out_name [proc_file_name_insert_str $file_out_name_common ${str_file_name_out_add}_${ind_file}]
